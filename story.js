...
(() => {
  ...
  const rock = svg(`
    ...
    <g class="photo-scan photo-scan-a" fill="none">
      ...
      <text x="548" y="165" fill="#e9fcff" font-family="monospace" font-size="11" letter-spacing="2">PYROXENITE / 01</text>
      <text x="548" y="181" fill="#aee0eb" font-family="monospace" font-size="9" letter-spacing="1.2">USGS · PHOTO ARCHIVE</text>
      <text x="548" y="197" fill="#aee0eb" font-family="monospace" font-size="9" letter-spacing="1.2">LAT/LON · NOT LISTED</text>
    </g>
    <g class="photo-scan photo-scan-b" fill="none">
      ...
      <text x="548" y="165" fill="#fff0f9" font-family="monospace" font-size="11" letter-spacing="2">VESICULAR BASALT</text>
      <text x="548" y="181" fill="#ecc6e6" font-family="monospace" font-size="9" letter-spacing="1.2">USGS · ROCK RECORD</text>
      <text x="548" y="197" fill="#ecc6e6" font-family="monospace" font-size="9" letter-spacing="1.2">LAT/LON · NOT LISTED</text>
    </g>
